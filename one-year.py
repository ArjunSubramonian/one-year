...
s = "\n\nHi sweetie!\n\n" + \
"\tI'm so lucky to have been with you for one whole year :)\n" + \
"\tYou make me happy beyond words, and I'm always daydreaming about you.\n" + \
"\tFrom our Friday trips and improptu dances in the Gardenia stairwell\n" + \
"\tto the meals we eat together and the nights I spend in your bed with your arms around me,\n" + \
"\tI genu-wine-ly value every picosecond I spend with you!\n" + \
"\tYou have almost single-handedly transformed my UCLA experience,\n" + \
"\tand I can't wait to spend the rest of my life with you <3 \n" + \
"\tI'm so fortunate to be able to grow with you as a person,\n" + \
"\traise kids (human and goat alike) with you,\n" + \
"\tand give you the biggest of hugs at the end of each day.\n" + \
"\t[Oops, I was supposed to keep this short so you don't have to type too much hehe]\n" + \
"\tAnyways, unfortunately, we can't be physically together for our anniversary\n" + \
"\tdue to this pandemic [time capsule material], but it's okay because you're always in my heart :)\n" + \
"\tHere's to infinity more years together, moving to Australia, our farm, the list goes on...\n\n" + \
"Sincerely,\n" + \
"Your favorite Koffee Koala <3\n\n" 

print(s)

for i in range(len(s)):
    if (i % 4) % 2 == 0:
        sys.stdout.write(str(ord(s[i]) + (i % 4)) + ', ')
    else:
        sys.stdout.write(repr(chr(ord(s[i]) + (i % 4))) + ', ') 
